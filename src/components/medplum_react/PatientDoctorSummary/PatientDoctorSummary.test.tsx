...
import { PatientDoctorSummary, PatientDoctorSummaryProps } from './PatientDoctorSummary';

const medplum = new MockClient();

describe('PatientDoctorSummary', () => {
  async function setup(args: PatientDoctorSummaryProps): Promise<void> {
    await act(async () => {
      render(
        <MemoryRouter>
          <MedplumProvider medplum={medplum}>
            <PatientDoctorSummary {...args} />
          </MedplumProvider>
        </MemoryRouter>
      );
    });
