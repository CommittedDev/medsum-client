...
import { ResourceTableInlineEditing, ResourceTableInlineEditingProps } from './ResourceTableInlineEditing';

const medplum = new MockClient();

describe('ResourceTableInlineEditing', () => {
  async function setup(props: ResourceTableInlineEditingProps, client?: MockClient): Promise<void> {
    await act(async () => {
      render(
        <MedplumProvider medplum={client ?? medplum}>
          <ResourceTableInlineEditing {...props} />
        </MedplumProvider>
      );
    });
  }
