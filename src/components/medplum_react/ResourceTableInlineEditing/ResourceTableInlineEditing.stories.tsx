...
import { ResourceTableInlineEditing } from './ResourceTableInlineEditing';

export default {
  title: 'Medplum/ResourceTableInlineEditing',
  component: ResourceTableInlineEditing,
} as Meta;

export const Patient = (): JSX.Element => (
  <Document>
    <ResourceTableInlineEditing value={HomerSimpson} />
  </Document>
);

export const Observation = (): JSX.Element => (
  <Document>
    <ResourceTableInlineEditing value={HomerObservation1} />
  </Document>
);

export const ObservationIgnoreEmpty = (): JSX.Element => (
  <Document>
    <ResourceTableInlineEditing value={HomerObservation1} ignoreMissingValues={true} />
  </Document>
);

export const Covid19PCRTestActivity = (): JSX.Element => (
  <Document>
    <ResourceTableInlineEditing value={Covid19PCRTest} ignoreMissingValues={true} />
  </Document>
);

export const Covid19ReviewReportActivity = (): JSX.Element => (
  <Document>
    <ResourceTableInlineEditing value={Covid19ReviewReport} ignoreMissingValues={true} />
  </Document>
);

export const Covid19SpecimenRequirement = (): JSX.Element => (
  <Document>
    <ResourceTableInlineEditing value={Covid19NasalSpecimen} ignoreMissingValues={true} />
  </Document>
);

export const Covid19ObservationDefinition = (): JSX.Element => (
  <Document>
    <ResourceTableInlineEditing value={Covid19PCRObservationDefinition} ignoreMissingValues={true} />
  </Document>
);
...
export const USCorePatient = (): JSX.Element => {
  ...
  return (
    <Document>
      <ResourceTableInlineEditing value={homerSimpsonUSCorePatient} profileUrl={profileSD.url} ignoreMissingValues />
    </Document>
  );
};
